 ...
 * the License.
 */
package com.dingziran.effective.generator;
...
import com.dingziran.effective.client.ShowcaseAnnotations.ShowcaseRaw;
...
public class ShowcaseGenerator extends Generator {
  ...
  private static final String[] SRC_CSS = {
      ...
      "com/dingziran/effective/client/Showcase.css"};
